  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: "#94A3B8", margin: 0 }}>
            Configure Classpulse for G.T.C Agidingbi
          </p>
        </div>
        <button
          onClick={save}
      ...
      <Section icon={MdAccessTime} title="Attendance Rules">
        ...
        >
          ...
          <Field
            ...
            hint="Minutes after start before marked late"
          >
            <input
              type="number"
              min="0"
          ...
          <Field
            label="Idle Class Threshold (mins)"
            hint="Minutes before a class is flagged idle"
          >
            <input
              type="number"
              min="5"
              ...
              onChange={(e) => handleChange("idleThreshold", e.target.value)}
              style={inp}
            />
          </Field>
        </div>
      ...
      <Section icon={MdNotifications} title="Notification Preferences">
        <ToggleRow
          label="Idle Class Alerts"
          desc="Notify when a class is unattended past the threshold"
          setting="notifyIdle"
        />
        <ToggleRow
          label="Late Arrival Alerts"
          desc="Notify when a teacher checks in after the start time"
          setting="notifyLate"
        />
        <ToggleRow
          label="Absent Teacher Alerts"
          desc="Notify when a teacher has not checked in by 9:00 AM"
          setting="notifyAbsent"
        />
        <ToggleRow
          label="Automated Reports"
          desc="Generate monthly reports automatically on last school day"
          setting="autoReports"
        />
      </Section>
      ...
      <Section icon={MdSecurity} title="Security">
        <ToggleRow
          ...
          desc="Require OTP verification on login for admin account"
          setting="twoFactor"
        />
        <div style={{ padding: "12px 0" }}>
          ...
          />
          <p style={{ fontSize: 11, color: "#94A3B8", margin: "4px 0 0" }}>
            Auto sign-out after this many hours of inactivity
          </p>
        </div>
      </Section>
